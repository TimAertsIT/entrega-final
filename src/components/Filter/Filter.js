...
const Filter = ({
    ...
    const handleIndoorClick = () => {
        setIndoorSelected(!indoorSelected);
    };
    const handleOutdoorClick = () => {
        setOutdoorSelected(!outdoorSelected);
    };
    const handleFullShadeClick = () => {
        setFullShadeSelected(!fullShadeSelected);
    };
    const handlePartShadeClick = () => {
        setPartShadeSelected(!partShadeSelected);
    };
    const handlePartSunClick = () => {
        setPartSunSelected(!partSunSelected);
    };
    const handleFullSunClick = () => {
        setFullSunSelected(!fullSunSelected);
    };
    const handleFrequentClick = () => {
        setFrequentSelected(!frequentSelected);
    };
    const handleAverageClick = () => {
        setAverageSelected(!averageSelected);
    };
    const handleMinimalClick = () => {
        setMinimalSelected(!minimalSelected);
    };
